...
namespace net8.Controllers
{
    ...
    [ApiController]
    public class GetRecentCoinVideoController : ControllerBase
    {
        [HttpGet]
        public async void GetRecentCoinVideo ([FromServices] HttpClientManager httpClientManager,uint vmid)
        {
            string baseUrl = "https://api.bilibili.com/x/space/coin/video?";
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if ((int)jsonObject["code"] == 0)
                    {
                        if (jsonObject["data"] != null)
                        {
                            ...
                            long mid = vmid;
                            var videoArray = jsonObject["data"] as JArray;
                            ...
                            InsertCoinVideo.InsertCoinVideoData(userLikes);
